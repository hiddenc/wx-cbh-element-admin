<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="展品分类名" width="300px" align="center">
    ...
    getList: async function() {
      ...
      db.collection('exhibits_label')
        ...
        .then(res => {
          ...
          console.log(this.exhibits_label)
        })
